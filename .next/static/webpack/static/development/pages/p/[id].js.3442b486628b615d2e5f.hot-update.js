...
function Post() {
  ...
  var name = _components_River__WEBPACK_IMPORTED_MODULE_4__["default"].name;
  var riverId = router.query.id;
  ...
  var riverReview = __jsx("div", {
    ...
    __self: this
  }, router.query.id), "if(", riverId, " == ", name, ")", __jsx(_components_RiversList__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16
    },
...
//# sourceMappingURL=[id].js.3442b486628b615d2e5f.hot-update.js.map