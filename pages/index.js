...
Index.getInitialProps = async () => {
    const response = await fetch('http://localhost:3000/api/river')
    const river = await response.json()
...
//                         className="card"
//                     >
//                         <h3>Add New River &rarr;</h3>
//                         <p>Cant find a river? Feel free to add a river here!</p>
//                     </a>
//                 </div>
//             </div>
